...
module.exports = function (app) {
    ...
    authRoutes.get('/getUserInfo/client/:id',auth.validateClaims,authController.getAuthenticatedUser);
    authRoutes.get('/getUserInfo/api/:id',auth.validateClaims,authController.getAuthenticatedUser);
